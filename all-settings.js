...
const BOUNDS = {
  ...
  maxDeployAmount: [0.1, Infinity], maxSwapPriceImpactPct: [0.1, 50], maxCloseSwapPriceImpactPct: [0.1, 90],temperature: [0, 2], maxTokens: [256, 200_000], maxSteps: [1, 100],
...
export function createAllSettings(deps) {
  ...
  function risk(entry, value) {
    ...
    if (k === "maxCloseSwapPriceImpactPct") return up("the post-close swap price-impact cap");
